        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-7">
              ...
              >
                Securing the <span className="text-cyber-accent">Digital Frontier</span>
              </motion.h1>
              ...
              >
                Cybersecurity professional with expertise in penetration testing, network security, 
                and threat intelligence. Helping organizations protect their most valuable digital assets.
              </motion.p>
              ...
              >
                ...
                >
                  <Link href="https://dipnarayan.bio.link/" target="_blank" className="flex items-center">
                ...
                >
                  <Link href="/blog" className="flex items-center">
                    Read Blog
                    <ExternalLink size={16} className="ml-2 opacity-70 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
              </motion.div>
              ...
              >
                ...
                <div className="flex gap-6">
                  ...
                  >
                    <span className="font-mono text-sm font-bold bg-cyber-secondary/80 py-1 px-3 rounded-md border border-cyber-accent/20">AWS</span>
                  </motion.div>
                  <motion.div 
                    whileHover={{ y: -5 }}
                    transition={{ type: "spring", stiffness: 400, damping: 10 }}
                    className="h-8 text-muted-foreground hover:text-foreground hover:text-cyber-accent transition-colors"
                  >
                    <span className="font-mono text-sm font-bold bg-cyber-secondary/80 py-1 px-3 rounded-md border border-cyber-accent/20">Fortinet</span>
                  </motion.div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="mt-6 space-y-1">
                      ...
                      <div className="text-sm font-mono text-cyber-accent/70 mt-2 flex flex-wrap justify-center gap-2">
                        <span className="bg-cyber-dark/50 px-3 py-1 rounded-full border border-cyber-accent/10">Network Security</span>
                        <span className="bg-cyber-dark/50 px-3 py-1 rounded-full border border-cyber-accent/10">Threat Detection</span>
                        <span className="bg-cyber-dark/50 px-3 py-1 rounded-full border border-cyber-accent/10">Cloud Security</span>
                      </div>
                    </div>
                  </div>
                </div>
